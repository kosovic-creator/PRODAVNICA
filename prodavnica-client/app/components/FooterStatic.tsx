...
/**
 * Statička verzija footer-a za server-side rendering
 * Bez lokalizacije - samo čekaj HydrationGuard da primijeni client-side lokalizaciju
 */
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-sm text-slate-400 leading-relaxed mb-4">
            {/* Lokalizacija primijeni sa client side */}
          </p>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-center sm:text-left">
        <p className="text-slate-400 text-sm">
          ...
          <span className="ml-2">{/* All Rights Reserved */}</span><br className="sm:hidden" />
